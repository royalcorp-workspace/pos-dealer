...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Halo,</p>
            <p>Terima kasih atas pesanan Anda. Kami telah menerima pesanan Anda dengan rincian sebagai berikut:</p>
            <ul>
                <li><strong>Nomor Pesanan:</strong> {{ $order->order_number }}</li>
                <li><strong>Total Pembayaran:</strong> Rp {{ number_format($order->total, 0, ',', '.') }}</li>
            </ul>
            <p>Harap segera melakukan pembayaran agar pesanan dapat diproses.</p>
