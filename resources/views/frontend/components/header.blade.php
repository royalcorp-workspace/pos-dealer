...
<header class="w-full bg-white border-b border-gray-100 sticky top-0 z-40 shadow-sm font-sans" x-data="{ activeMegaMenu: null }">
    ...
    <div class="container mx-auto px-4 md:px-6 h-auto py-3 md:h-20 md:py-0 flex flex-nowrap items-center justify-between gap-3 md:gap-6">
        ...
        <div class="flex items-center gap-2 sm:gap-3">
            ...
            <button 
                ...
                class="flex items-center transition-all duration-300 focus:outline-none cursor-pointer group relative {{ $cartItemCount > 0 ? 'bg-brand-light/80 hover:bg-brand-gold/15 px-3 sm:px-4 py-2 rounded-full border border-brand-muted/80 hover:border-brand-gold/50 gap-2 sm:gap-2.5' : 'justify-center w-10 h-10 rounded-full bg-gray-50 hover:bg-brand-gold/15 border border-gray-200/80' }}"
            ...
            >
                <div class="relative">
                    ...
                    @if($cartItemCount > 0)
                        <span id="cart-count-badge" class="absolute -top-2 -right-2 bg-brand-dark text-brand-gold text-[9px] font-black min-w-[16px] h-[16px] px-1 rounded-full flex items-center justify-center shadow-xs border border-brand-gold/40">
                            {{ $cartItemCount }}
                        </span>
                    @endif
                </div>
            ...
            <ul class="flex items-center gap-8 h-14 relative">
                ...
                >
                    ...
                    <div 
                        ...
                        class="absolute top-full left-0 w-80 bg-white shadow-xl border border-brand-muted/80 rounded-2xl p-4 z-50 overflow-hidden"
                    >
                        <div class="space-y-1">
                ...
                <!-- Pilihan Brand Dropdown Trigger -->
                <li 
                    class="h-full flex items-center cursor-pointer relative"
                ...
                >
                    ...
                    <div 
                        ...
                        x-transition:leave-start="opacity-100 translate-y-0 scale-100"
                        x-transition:leave-end="opacity-0 translate-y-2 scale-98"
                        class="absolute top-full left-0 w-72 bg-white shadow-xl border border-brand-muted/80 rounded-2xl p-4 z-50 overflow-hidden"
                    >
                        <div class="space-y-1">
    ...
    <div 
        ...
        x-cloak
        class="md:hidden border-t border-brand-muted/60 bg-white overflow-hidden shadow-2xl max-h-[85vh] overflow-y-auto"
    ...
    >
        <div class="p-4 space-y-4 font-sans">
            ...
            <div class="border border-brand-muted/70 rounded-2xl overflow-hidden">
                ...
                <div x-show="openSection === 'categories'" x-collapse class="bg-brand-light/50 border-t border-brand-muted/40 p-2 space-y-1">
                    @foreach($categories as $category)
                        <a 
                            href="{{ route('category.show', $category->slug) }}" 
            ...
            <div class="border border-brand-muted/70 rounded-2xl overflow-hidden">
                ...
                <div x-show="openSection === 'brands'" x-collapse class="bg-brand-light/50 border-t border-brand-muted/40 p-2 space-y-1">
                    @foreach($brands as $brand)
                        <a 
                            href="{{ route('brands.show', $brand->slug) }}" 
                            class="block p-2.5 rounded-lg text-sm text-gray-700 font-medium hover:bg-white hover:text-brand-gold-dark transition-colors text-left"
