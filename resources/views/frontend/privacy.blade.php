...
@section('title', $privacy->meta_title ?? 'Kebijakan Privacy - IMG')
@section('meta_description', $privacy->meta_description ?? 'Kebijakan privasi data pribadi pengguna layanan IMG.')
...
@section('content')
    <div class="container mx-auto px-4 md:px-6 py-12 min-h-[70vh] font-sans">
        <div class="max-w-4xl mx-auto">
            @if($privacy)
                <h1 class="text-3xl md:text-4xl font-extrabold text-brand-dark font-serif mb-6">{{ $privacy->title }}</h1>
