...
@section('title', $terms->meta_title ?? 'Syarat dan Ketentuan - IMG')
@section('meta_description', $terms->meta_description ?? 'Syarat dan ketentuan penggunaan layanan IMG International Mattress Gallery.')
...
@section('content')
    <div class="container mx-auto px-4 md:px-6 py-12 min-h-[70vh] font-sans">
        <div class="max-w-4xl mx-auto">
            @if($terms)
                <h1 class="text-3xl md:text-4xl font-extrabold text-brand-dark font-serif mb-6">{{ $terms->title }}</h1>
