...
Route::get('/checkout/cities', [CheckoutController::class, 'getCitiesAjax'])->name('checkout.cities');
Route::get('/checkout/sub-districts', [CheckoutController::class, 'getSubDistrictsAjax'])->name('checkout.sub-districts');
